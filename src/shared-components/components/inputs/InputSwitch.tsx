  ...
  return (
    <div className="switch-container">
      <div className="labelWrapper">
        {label && <span className="body-m-medium text-default">{label}</span>}
        {placeholder && (
          <span className="body-s-multiline text-secondary">{placeholder}</span>
        )}
      </div>

      <div className="input-containerSwitch">
        <Controller
          name={name}
          control={control}
